...
public class SearchActivity extends AppCompatActivity {
    ...
    private void getSearchItemList(String diet) throws JSONException {


        mSearchList = new ArrayList<>();
        //SearchActivity.url //+= diet;

        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url + mCurrentDiet, new Response.Listener<JSONArray>() {
